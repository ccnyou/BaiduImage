...
- (void)flashMessage:(NSString *)msg{
    ...
    if (_msgLabel == nil) {
        ...
        _msgLabel.backgroundColor = [UIColor colorWithRed:90.0/255.0 green:169/255.0 blue:168/255.0 alpha:1];
...
- (void)observeValueForKeyPath:(NSString *)keyPath ofObject:(id)object change:(NSDictionary *)change context:(void *)context
{
    ...
    if (self.autoScrollToNextPage && _isFooterInAction) {
        ...
        _isFooterInAction = NO;
    } else if (_isFooterInAction && !_isChangeFrame) {
